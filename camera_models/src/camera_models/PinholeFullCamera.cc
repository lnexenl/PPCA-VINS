...
namespace camodocal {
    ...
    PinholeFullCamera::Parameters::Parameters()
            : Camera::Parameters(PINHOLE_FULL), m_k1(0.0), m_k2(0.0), m_k3(0.0), m_k4(0.0), m_k5(0.0), m_k6(0.0),
              m_p1(0.0), m_p2(0.0), m_fx(0.0), m_fy(0.0), m_cx(0.0), m_cy(0.0) {
    }
    ...
    PinholeFullCamera::Parameters::Parameters(const std::string &cameraName, //
                                              ...
                                              double cx,
                                              double cy)
            : Camera::Parameters(PINHOLE_FULL, cameraName, w, h), m_k1(k1), m_k2(k2), m_k3(k3), m_k4(k4), m_k5(k5),
              m_k6(k6), m_p1(p1), m_p2(p2), m_fx(fx), m_fy(fy), m_cx(cx), m_cy(cy) {
    }
 ...
 */
    ...
    PinholeFullCamera::initUndistortRectifyMap(
            cv::Mat &map1, cv::Mat &map2, float fx, float fy, cv::Size imageSize, float cx, float cy,
            cv::Mat rmat) const {
